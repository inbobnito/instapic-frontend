...
The app can be found [here](https://safe-fortress-25417.herokuapp.com/).
...
As with the backend, I didn't get the time to implement testing, unfortunately. I'd like to break out the actions and reducers as well now that I get the way Redux does things. Passwords are encrypted but no email/phone authentication. Form validation is pretty minimal.
